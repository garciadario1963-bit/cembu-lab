...
<style>
    ...
    /* Barra de redes sociales en banner */
    .social-bar {
        display: flex;
...
# 2. Header con Redes Sociales y Título
st.markdown("""
<div class="social-bar">
    ...
    <a href="https://facebook.com" target="_blank" class="social-icon" title="Facebook">
        <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24"><path d="M9 8H6v4h3v12h5V12h3.642L18 8h-4V6.333C14 5.374 14.5 5 15.5 5H18V0h-3.808C10.592 0 9 1.847 9 5.052V8z"/></svg>
    </a>
...
if pestana == "Tablero de Control":
    ...
    # B) Fila principal: Carrusel y Mapa
    ...
    with col_left:
        ...
        <div style="background:#ffffff; padding:15px; border-radius:8px; border:1px solid #ddd; height:380px; display:flex; flex-direction:column; justify-content:space-between;">
            <div>
                ...
                <div style="background:#f0f0f0; height:180px; border-radius:6px; display:flex; align-items:center; justify-content:center; color:#888;">
