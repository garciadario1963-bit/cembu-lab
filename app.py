...
# 3. HEADER NEGRO CON REDES SOCIALES COMERCIALES Y CANAL PÚBLICO DE YOUTUBE
st.markdown("""
<div class="top-black-banner">
    ...
    <div class="social-icons-container">
        ...
        <!-- LinkedIn -->
        <a href="https://www.linkedin.com/company/cembuorg" target="_blank" class="social-link" title="LinkedIn">
